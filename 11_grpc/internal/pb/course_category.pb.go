...
type CreateCategoyRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *CreateCategoyRequest) Reset() {
	*x = CreateCategoyRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *CreateCategoyRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CreateCategoyRequest) ProtoMessage() {}

func (x *CreateCategoyRequest) ProtoReflect() protoreflect.Message {
	mi := &file_proto_course_category_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CreateCategoyRequest.ProtoReflect.Descriptor instead.
func (*CreateCategoyRequest) Descriptor() ([]byte, []int) {
	return file_proto_course_category_proto_rawDescGZIP(), []int{2}
}

func (x *CreateCategoyRequest) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *CreateCategoyRequest) GetDescription() string {
	if x != nil {
		return x.Description
	}
	return ""
...
var file_proto_course_category_proto_rawDesc = []byte{
	...
	0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x79, 0x52, 0x65, 0x71,
	...
	0x12, 0x42, 0x0a, 0x0e, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f,
	0x72, 0x79, 0x12, 0x18, 0x2e, 0x70, 0x62, 0x2e, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x43, 0x61,
	0x74, 0x65, 0x67, 0x6f, 0x79, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x14, 0x2e, 0x70,
	...
	0x62, 0x2e, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x22, 0x00, 0x12, 0x46, 0x0a, 0x14,
	...
	0x43, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x79, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x10,
	0x2e, 0x70, 0x62, 0x2e, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x4c, 0x69, 0x73, 0x74,
	0x22, 0x00, 0x28, 0x01, 0x12, 0x51, 0x0a, 0x21, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x43, 0x61,
	0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x42, 0x69, 0x64, 0x69,
	0x72, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x61, 0x6c, 0x12, 0x18, 0x2e, 0x70, 0x62, 0x2e, 0x43,
	0x72, 0x65, 0x61, 0x74, 0x65, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x79, 0x52, 0x65, 0x71, 0x75,
...
var file_proto_course_category_proto_goTypes = []interface{}{
	...
	(*CreateCategoyRequest)(nil), // 2: pb.CreateCategoyRequest
...
var file_proto_course_category_proto_depIdxs = []int32{
	...
	2, // 2: pb.CategoryService.CreateCategory:input_type -> pb.CreateCategoyRequest
	...
	2, // 5: pb.CategoryService.CreateCategoryStream:input_type -> pb.CreateCategoyRequest
	2, // 6: pb.CategoryService.CreateCategoryStreamBidirectional:input_type -> pb.CreateCategoyRequest
...
func file_proto_course_category_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_course_category_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CreateCategoyRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
