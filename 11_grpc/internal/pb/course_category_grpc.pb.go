...
type CategoryServiceClient interface {
	CreateCategory(ctx context.Context, in *CreateCategoyRequest, opts ...grpc.CallOption) (*CategoryResponse, error)
...
func (c *categoryServiceClient) CreateCategory(ctx context.Context, in *CreateCategoyRequest, opts ...grpc.CallOption) (*CategoryResponse, error) {
...
type CategoryService_CreateCategoryStreamClient interface {
	Send(*CreateCategoyRequest) error
...
func (x *categoryServiceCreateCategoryStreamClient) Send(m *CreateCategoyRequest) error {
...
func (x *categoryServiceCreateCategoryStreamBidirectionalClient) Send(m *CreateCategoyRequest) error {
	return x.ClientStream.SendMsg(m)
}
...
type CategoryServiceServer interface {
	CreateCategory(context.Context, *CreateCategoyRequest) (*CategoryResponse, error)
...
func (UnimplementedCategoryServiceServer) CreateCategory(context.Context, *CreateCategoyRequest) (*CategoryResponse, error) {
...
func _CategoryService_CreateCategory_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CategoryServiceServer).CreateCategory(ctx, req.(*CreateCategoyRequest))
	}
...
type CategoryService_CreateCategoryStreamServer interface {
	...
	Recv() (*CreateCategoyRequest, error)
	grpc.ServerStream
}
...
func (x *categoryServiceCreateCategoryStreamServer) Recv() (*CreateCategoyRequest, error) {
	m := new(CreateCategoyRequest)
...
func (x *categoryServiceCreateCategoryStreamBidirectionalServer) Recv() (*CreateCategoyRequest, error) {
	m := new(CreateCategoyRequest)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
